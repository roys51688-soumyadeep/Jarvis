...
import os
client = OpenAI(
    api_key="(api_key=os.environ.get(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")
